...
- [x] 1.1 Add a `Clock` parameter to `HelloWorld.appendGreeting` (and thread
...
- [x] 1.2 Verify existing save-related tests
...
- [x] 2.1 Add a helper that recognizes whether a stored history line starts
      ...
      plain greeting text`).
- [x] 2.2 Update `run`'s history printing to use this helper so a
      ...
      lines correctly`).
- [x] 2.3 Verify existing history-printing tests
...
- [x] 3.1 Run the full Spock suite (`./gradlew test`) and confirm all tests
