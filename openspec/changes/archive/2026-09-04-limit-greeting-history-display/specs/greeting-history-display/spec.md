...
- **THEN** the system prints the line `and 3 more earlier.` before the 5 displayed
  history lines

#### Scenario: Exactly 5 greetings exist
- **WHEN** the greeting history file contains exactly 5 lines
- **THEN** the system prints all 5 lines and does not print an `and ... more earlier.` line

#### Scenario: Fewer than 5 greetings exist
- **WHEN** the greeting history file contains 2 lines
- **THEN** the system prints both lines and does not print an `and ... more earlier.` line
...
- **THEN** the system reports `This is greeting number 9.` even though only 5
  history lines and the "and more earlier" summary were printed
