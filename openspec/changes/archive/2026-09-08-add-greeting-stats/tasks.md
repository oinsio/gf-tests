...
- [x] 1.1 Create `src/main/java/com/example/GreetingStats.java` with a
...
- [x] 1.2 Print `No greetings saved yet.` when there are no saved
...
- [x] 2.1 In `HelloWorld.main`, detect `--stats` in `args` and delegate to
...
- [x] 3.1 Write `src/test/groovy/com/example/GreetingStatsSpec.groovy`
