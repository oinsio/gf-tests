...
- [ ] 1.1 Change `HelloWorld.run` to print at most the last 5 entries of
...
- [ ] 1.2 Add a Spock test for a history of 6+ lines confirming only the last
...
- [ ] 2.1 Print `и ещё N ранее` before the shown greetings whenever
...
- [ ] 2.2 Confirm no summary line is printed when history has exactly 5 or
...
- [ ] 3.1 Confirm "Это приветствие номер N." still uses the true total
