...
- [ ] 1.1 In `HelloWorld.run`, reverse the `displayedHistory` slice before
...
- [ ] 1.2 Verify the greeting-number output and history selection (which
...
- [ ] 2.1 Update existing `HelloWorldSpec` cases that assert oldest-first
