...
- [x] 2.1 Print `и ещё N ранее.` before the displayed history entries when
...
- [x] 2.2 Omit the `и ещё N ранее.` line when the history has exactly 5,
...
- [x] 3.1 Confirm `Это приветствие номер N.` still reports the full history
